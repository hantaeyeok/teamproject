               ...
               <table class="table" style="margin:0 auto;">
                   <tbody>
                       ...
                       <tr>
                           ...
                           <!-- as기간은 무조건 넣어야함, as 외래키 추가할 예정임 -->
                           <td>
                               <input type="number" value="${product.asdate}" name="asdate" id="asdate" class="input" required/>
                           </td>
                       </tr>
                   </tbody>
               </table>
